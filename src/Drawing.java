...
public class Drawing extends JPanel implements MouseListener, MouseMotionListener{
	...
	public void mouseDragged(MouseEvent me) {
		...
		if (this.currentFigureName.equals("rectangle")) {
			...
			currentFig = new Carre(largeur,hauteur,currentColor);
		} else if (this.currentFigureName.equals("ellipse")) {
			currentFig = new Ellipse(largeur,hauteur,currentColor);
		} else {
			currentFig = new Cercle(largeur,hauteur,currentColor);
		}
		
		currentFig.setPoint(new Point(pos1.x<pos2.x?pos1.x:pos2.x, pos1.y<pos2.y?pos1.y:pos2.y));
